...
if (isset($_GET['delete'])) {
    $sno = $_SESSION['email'];
    $sql = "DELETE FROM `blood-request` WHERE `email` = '$sno'";
            ...
            <div class="modal-content bg-dark text-white">
                ...
                <form action="edit-booking.php" method="post" class="item-center mx-5 bg-dark text-white">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" readonly>
                    </div>
                    <hr>
        ...
        <div class="m-5">
            <table class="table table-dark table-striped table-hover text-center" id="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT `user_mail`, `blood_group`, `unit`, `req_expire_date` FROM `blood-request` WHERE `user_mail` = '$email'";
                    $result = mysqli_query($conn, $sql);
    ...
    <script>
        ...
        Array.from(edits).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                email.value = tr.getElementsByTagName("td")[0].innerText;
                bloodgroup.value = tr.getElementsByTagName("td")[1].innerText;
                quantity.value = tr.getElementsByTagName("td")[2].innerText;
                date.value = tr.getElementsByTagName("td")[3].innerText;

                console.log(email.value, bloodgroup.value, quantity.value, date.value);
